<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCar.aspx.cs" Inherits="CarRental.Admin.AddCar" %>
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <asp:Button ID="uploadcardata" runat="server" class="btn btn-primary w-100" Text="Upload" OnClick="uploadcardata_Click" />
                </form>
                <asp:Repeater ID="cardata" runat="server">
                    <HeaderTemplate>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><%# Eval("car_description") %></td>
                            <td><%# Eval("car_quantity") %></td>
                            <td><asp:Image runat="server" ImageUrl='<%# "~/Admin/upload/" + Eval("car_image") %>' class="img-size-64" alt="Car Image" /></td>
                            <td><a href="Opration.aspx?action=Update&id=<%# Eval("car_id") %>" class="fa fa-pen text-primary"></a>&nbsp
                                <a href="Opration.aspx?action=Delete&id=<%# Eval("car_id") %>" class="fa fa-trash text-danger"></a>
                            </td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
