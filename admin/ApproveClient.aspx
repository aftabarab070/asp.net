<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveClient.aspx.cs" Inherits="CarRental.Admin.ApproveClient" %>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Approve Client</h1>
                        </div>
                    </div>
                    <!-- /.row -->
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="deleteclient.php" method="POST">
                                                <input type="hidden" name="delete_id" value="<%# Eval("id") %>">
