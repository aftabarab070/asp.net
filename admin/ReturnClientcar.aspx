<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/Admin/ReturnClientcar.aspx.cs" CodeBehind="ReturnClientcar.aspx.cs" Inherits="CarRental.Admin.ReturnClientcar" %>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Return Client Car</h1>
                        </div>
                    </div>
                    <!-- /.row -->
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="deleteclient.php" method="POST">
                                                <input type="text" name="delete_id" value="<%# Eval("id") %>">
                                                <input type="text" name="delete_email" value="<%# Eval("email") %>">
